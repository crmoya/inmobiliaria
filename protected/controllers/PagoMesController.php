...
class PagoMesController extends Controller
{
    ...
    public function actionVerDetalle($id){
        ...
        $pagos = PagoMes::model()->findAll(array(
            'condition'=>'contrato_id = :contrato_id',
            'order'=>'fecha DESC',
            'params'=>array(':contrato_id'=>$id)
        ));
	...
	{
		$dataProvider=new CActiveDataProvider('PagoMes');
	 ...
	 * @return PagoMes the loaded model
	 ...
	 * @param PagoMes $model the model to be validated
	 */
    ...
    public function actionExportarXLS($id) {
        ...
        $pagos = PagoMes::model()->findAll(array(
            'select'=>'t.* ,c.folio',
            'join'=>'JOIN contrato AS c ON t.contrato_id = c.id',
            'condition'=>'contrato_id = :contrato_id',
            'order'=>'fecha DESC',
            'params'=>array(':contrato_id'=>$id)
        ));
