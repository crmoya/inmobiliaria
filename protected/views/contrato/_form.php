...
<div class="form">
    ...
    <?php
        //no sé qué error lanza esto, así es que voy a comentarlo para poder probar mis cambios
        //echo ($model->isNewRecord) ? $form->errorSummary($model, $ctaModel) : $form->errorSummary($model); 
